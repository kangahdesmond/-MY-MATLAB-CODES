...
P1_TrainingData = xlsread('hybrid train.xlsx',1);

%Reading Piezometer 1 Testing Data 
P1_TestingData = xlsread('hybrid test.xlsx',1);

%Transposing the Piezometer 1 Data
P1_TrainingInputset = transpose(P1_TrainingData(:,2));
P1_TrainingTargetset = transpose(P1_TrainingData(:,1));

P1_TestingInputset = transpose(P1_TestingData(:,2));
P1_TestingTargetset = transpose(P1_TestingData(:,1));
