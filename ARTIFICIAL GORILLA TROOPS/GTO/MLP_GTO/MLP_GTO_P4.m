...
P4_TrainingData = xlsread('Training.xlsx',4);

%Reading Piezometer 1 Testing Data 
P4_TestingData = xlsread('Testing.xlsx',4);

%Transposing the Piezometer 1 Data
P4_TrainingInputset = transpose(P4_TrainingData(:,1:4));
P4_TrainingTargetset = transpose(P4_TrainingData(:,5));

P4_TestingInputset = transpose(P4_TestingData(:,1:4));
P4_TestingTargetset = transpose(P4_TestingData(:,5));
