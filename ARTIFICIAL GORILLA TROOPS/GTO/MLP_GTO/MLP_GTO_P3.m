...
P3_TrainingData = xlsread('Training.xlsx',3);

%Reading Piezometer 1 Testing Data 
P3_TestingData = xlsread('Testing.xlsx',3);

%Transposing the Piezometer 1 Data
P3_TrainingInputset = transpose(P3_TrainingData(:,1:4));
P3_TrainingTargetset = transpose(P3_TrainingData(:,5));

P3_TestingInputset = transpose(P3_TestingData(:,1:4));
P3_TestingTargetset = transpose(P3_TestingData(:,5));
