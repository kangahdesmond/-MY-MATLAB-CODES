...
P2_TrainingData = xlsread('Training.xlsx',2);

%Reading Piezometer 1 Testing Data 
P2_TestingData = xlsread('Testing.xlsx',2);

%Transposing the Piezometer 1 Data
P2_TrainingInputset = transpose(P2_TrainingData(:,1:4));
P2_TrainingTargetset = transpose(P2_TrainingData(:,5));

P2_TestingInputset = transpose(P2_TestingData(:,1:4));
P2_TestingTargetset = transpose(P2_TestingData(:,5));
