...
for starting_point = 10:10:100
    S.Start_Point = starting_point;            
    S.Maximum_Generation  = 150;     
...
W = 1:S.Maximum_Generation+1;
F_sort = sort(F,'descend');
txt = ['Start Point = ', num2str(starting_point)];
plot(W,F_sort,'LineWidth',1,'DisplayName', txt)
xlabel('Iterations')
